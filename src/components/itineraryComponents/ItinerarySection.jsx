...
import { Package, Plus, MapPin, Calendar, Clock, Edit, Trash2, MapIcon } from 'lucide-react';
      ...
      <div className="space-y-4">
        {itineraries.length === 0 ? (
          ...
          <div className="space-y-6">
            ...
            {/* Itinerary Days */}
            <div className="space-y-6">
              {getDaysArray(selectedTrip.startDate, selectedTrip.endDate).map((day) => {
                const dayItinerary = itineraries?.find((item) => item.date.split("T")[0] === day)
                      ...
                      {dayItems.length === 0 ? (
                        ...
                        <div className="space-y-4">
                          {dayItems
                            ...
                            .map((item) => (
                              <div key={item.name} className="flex items-start space-x-4 p-4 bg-white border rounded-lg">
